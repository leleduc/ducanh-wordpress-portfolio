...
<footer class="footer-section dark-bg-1">
	<div class="container">
			...
			<div class="col-xl-12 text-center">
				<div class="footer-inner d-flex align-items-center justify-content-center">
					<div class="footer-circle-wrap">
						<img src="<?= $theme_uri; ?>/img/shape/footer-circle.png" alt="">
					</div>
					<div class="footer-content">
						<h2>Lets Say Hi</h2>
						<p><?= $contact_email; ?></p>
						<div class="footer-social-area-wrap">


							<li id="block-9" class="widget widget_block">
								<ul class="is-layout-flex wp-block-social-links">
									<li class="wp-social-link wp-social-link-linkedin wp-block-social-link">
										<a href="<?= $contact_linkedin; ?>" class="wp-block-social-link-anchor">
									...
									<li class="wp-social-link wp-social-link-youtube wp-block-social-link">
										<a href="<?= $contact_youtube; ?>" class="wp-block-social-link-anchor">
									...
									<li class="wp-social-link wp-social-link-github wp-block-social-link">
										<a href="<?= $contact_github; ?>" class="wp-block-social-link-anchor">
		...
		<div class="footer-ellipse">
			<img src="<?= $theme_uri; ?>/img/shape/footer-ellipse.png" alt="">
		</div>
	</div>
	<div class="footers-shape-one">
		<img src="<?= $theme_uri; ?>/img/shape/footer-shapes-1.png" alt="">
	</div>
